                                ...
                                >
                                    ...
                                    <div className="p-6 text-center">
                                        ...
                                        <div className="mt-4 space-y-3">
                                            ...
                                            {founder.awards && founder.awards.length > 0 && (
                                                <div>
                                                    <div className="text-xl font-semibold mb-2 text-black">Notable Achievements</div>
                                                    <div className="flex flex-wrap gap-2 justify-center">
                                                        {founder.awards.slice(0, 3).map((award, i) => (
                                                            <div key={i} className="badge badge-outline text-black border-gray-400 bg-white">
                                                                ✅ {award}
                                                            </div>
                                                        ))}
                                                    </div>
