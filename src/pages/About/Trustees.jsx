...
const Trustees = () => {
    ...
    if (error) {
        return (
            <div className="alert alert-error max-w-md mx-auto bg-white w-full">
    ...
    return (
        <div className="w-full bg-white min-h-screen">
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-center mb-8 text-black">Our Trustees</h1>

                {trustees.length === 0 ? (
                    <div className="alert alert-info max-w-md mx-auto bg-white">
                        <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {trustees.map(trustee => (
                            <div key={trustee._id} className="card bg-white shadow-xl min-h-[500px] flex flex-col border border-gray-200">
                                ...
                                <div className="card-body items-center text-center">
                                    <h2 className="card-title text-3xl text-black">{trustee.name}</h2>
                                    <div className='inline-block px-3 py-1 text-sm font-medium rounded-none mt-2 bg-primary text-white text-xl'>
                                        {trustee.designation}
                                    </div>

                                    {trustee.awards && trustee.awards.length > 0 && (
                                        <div className="mt-2">
                                            <h3 className="font-semibold mb-1 text-black">Awards:</h3>
                                            <ul className="space-y-1">
                                                {trustee.awards.map((award, index) => (
                                                    <li key={index} className="flex items-start justify-center text-gray-700">
