...
const Trustees = () => {
    ...
    return (
        <div className="min-h-screen bg-base-100 py-12 px-4 sm:px-6 lg:px-8">
            {/* Header Section */}
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-red-600 mb-3">
                    Board of Trustees
                </h1>
                <p className="text-xl text-base-content/70 max-w-2xl mx-auto">
                    Dedicated stewards guiding our organization's mission
            ...
            {/* Error State */}
            {error && (
                <div className="alert bg-red-600 text-white max-w-2xl mx-auto my-8 shadow-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Error: {error}</span>
            ...
            {!loading && !error && (
                <div className="max-w-7xl mx-auto">
                    {trustees.length === 0 ? (
                        <div className="text-center py-16">
                            <div className="max-w-md mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                </svg>
                                <h3 className="text-lg font-medium mt-4">No Trustees Found</h3>
                                <p className="mt-1 text-base-content/70">We couldn't find any trustees in our records.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {trustees.map((trustee, index) => (
                                ...
                                >
                                    <figure className="px-8 pt-8">
                                        <div className="avatar">
                                            <div className="w-40 h-40 rounded-full ring ring-red-600 ring-offset-base-100 ring-offset-2">
                                                <img
                                                    src={trustee.imageUrl || 'https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg'}
                                                    alt={trustee.name}
                                                    onError={(e) => {
                                    ...
                                    <div className="card-body items-center text-center pt-4">
                                        <h2 className="card-title text-2xl">{trustee.name}</h2>
                                        <div className="badge bg-red-600 text-white badge-lg mt-2">
                                            {trustee.designation}
                                        </div>
                                        ...
                                        {trustee.awards?.length > 0 && (
                                            <div className="mt-6 w-full">
                                                <div className="text-sm font-semibold mb-2 text-red-600">Key Contributions</div>
                                                <div className="flex flex-wrap gap-2 justify-center">
                                                    {trustee.awards.slice(0, 3).map((award, i) => (
                                                        <div key={i} className="badge badge-outline gap-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
