...
const Events = () => {
    ...
    return (
        <div className="bg-white min-h-screen w-full">
            <div className="container mx-auto px-4 py-8">
                {user && (
                    <div className="bg-gray-50 rounded-lg p-6 mb-8 shadow-lg border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {events.map(event => (
                        <div key={event._id} className="card bg-white shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-gray-200">
                            <figure className="relative aspect-video">
                                <img
                                    src={event.imageUrl}
                                    alt={event.title}
                            ...
                            <div className="card-body bg-white">
                                ...
                                <div
                                    className="prose prose-sm max-w-none whitespace-pre-line text-gray-800"
                                    dangerouslySetInnerHTML={{
                                        __html: truncateText(event.description, 20).replace(
                                            /(https?:\/\/[^\s]+)/g,
                                            '<a href="$1" target="_blank" rel="noopener noreferrer" class="text-blue-600">$1</a>'
                                        )
                                    }}
                                />
                                {event.description.split(' ').length > 20 && (
                                    <Link to={`/extraevents/${event._id}`} className="link link-primary mt-2 text-blue-600">
                                        Read more...
                                    </Link>
                                )}
                            </div>
