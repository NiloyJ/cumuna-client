...
//                                     </select>
//                                 </div>
//                                 <div className="absolute bottom-2 left-2 bg-white bg-opacity-80 px-2 py-1 rounded-md text-sm font-medium">
                    ...
                    {events.map(event => (
                        <div key={event._id} className="card bg-gray-800 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                            <figure className="relative aspect-video">
                                ...
                                <div className={`absolute bottom-2 left-2 px-2 py-1 rounded-md text-sm font-medium bg-opacity-80 ${event.status === 'upcoming' ? 'bg-info' : event.status === 'running' ? 'bg-success' : 'bg-white'}`}>
                                    {event.status ? event.status.charAt(0).toUpperCase() + event.status.slice(1) : 'Upcoming'}
                                </div>
                            </figure>
                            <div className="card-body bg-white text-gray-800">
