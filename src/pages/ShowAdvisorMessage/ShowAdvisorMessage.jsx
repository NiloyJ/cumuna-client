...
//     return (
//         <div className="w-full flex flex-col items-center justify-center py-10 px-4 bg-gray-100 overflow-hidden relative">
//             <h2 className="text-4xl font-bold mb-8 text-center text-gray-800 z-10">Meet Our Advisors</h2>

//             <div className="relative w-full max-w-3xl h-96">
//                 {/* Current Advisor (main card) */}
//                 <div className={`absolute bg-white rounded-3xl shadow-2xl p-10 w-full flex flex-col items-center transition-all duration-1000 ease-in-out ${
...
//                         />
//                     </div>
//                     <h3 className="text-2xl font-semibold text-gray-900">{currentAdvisor?.name}</h3>
//                     <p className="text-lg text-gray-500 mb-6">{currentAdvisor?.designation}</p>
//                     <p className="italic text-gray-700 text-center text-lg leading-relaxed max-w-2xl">
...
//                     }}>
//                         <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-blue-400 mb-4">
//                             <img
...
//                             />
//                         </div>
//                         <h3 className="text-xl font-semibold text-gray-800">{nextAdvisor?.name}</h3>
//                         <p className="text-md text-gray-500 mb-4">{nextAdvisor?.designation}</p>
//                     </div>
//                 )}
//             </div>
//         </div>
