        ...
        <div className="min-h-screen bg-white">
            <main className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                <div className="mb-12 text-center">
                    <h1 className="text-4xl font-bold text-black mb-2">CUMUNA Blog</h1>
                    <p className="text-xl text-gray-700">Discover the latest articles and updates</p>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-8 bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                    <input
                        ...
                        className="input input-bordered flex-grow bg-white text-black border-gray-300"
                        value={searchTerm}
                        onChange={(e) => setSearchTerm(e.target.value)}
                    />
                    <select
                        className="select select-bordered w-full md:w-64 bg-white text-black border-gray-300"
                ...
                {filteredBlogs.length > 0 ? (
                    ...
                    <div className="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-200">
                        <p className="text-xl text-gray-700 mb-4">No blog posts found matching your criteria.</p>
                        <button
                            className="btn btn-outline text-black border-gray-300 hover:bg-gray-100"
                            onClick={() => {
                                setSearchTerm('');
                                setCategoryFilter('');
                            }}
