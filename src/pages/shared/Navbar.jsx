...
//     return (
//         <div className="navbar bg-white text-black shadow-md px-4 sm:px-6 lg:px-8 xl:px-12 w-full min-h-[100px] md:min-h-[120px] sticky top-0 z-50">
...
//                             </svg>
//                         </div>
//                         <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-white text-black rounded-box w-52 text-lg">
...
//                             <div className={`hover:text-blue-600 cursor-pointer flex items-center gap-1 ${textSizes.base} px-2 py-1 text-black`}>
//                                 Community
//                                 <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
//                                     <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
//                                 </svg>
//                             </div>
//                             <ul className={`dropdown-content z-[1] menu p-2 shadow bg-white text-black rounded-box w-48 ${textSizes.dropdown}`}>
...
//                     {user ? (
//                         <>
//                             {/* Admin Dropdown - White bg, black text default / Blue bg, white text on hover */}
//                             <div className="dropdown dropdown-hover">
//                                 <div 
//                                     tabIndex={0} 
//                                     className="btn btn-sm px-2 bg-white text-black hover:bg-[#1963a7] hover:text-white transition-colors duration-200 cursor-pointer border border-gray-300"
//                                 >
//                                     Admin
...
//                                     </svg>
//                                 </div>
//                                 <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-white text-black rounded-box w-48">
...
//                                 className="btn btn-outline btn-sm border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-3 transition-colors duration-200">
//                                 Logout
//                             </button>
//                         </>
//                     ) : (
//                         <Link
//                             to="/signin"
//                             className="btn bg-[#1963a7] text-white hover:bg-[#0e4a7a] rounded-full px-4 py-1 text-sm transition-colors duration-200"
//                         >
//                             Sign In
//                         </Link>
//                     )}
        ...
        <div className="navbar bg-white text-black shadow-md px-4 sm:px-6 lg:px-8 xl:px-12 w-full min-h-[100px] md:min-h-[120px] sticky top-0 z-50">
            <div className="flex justify-between items-center w-full">
                ...
                <div className="flex items-center justify-between w-full lg:w-auto">
                    ...
                    {/* Hamburger Menu - NO hover background */}
                    <div className="dropdown lg:hidden">
                        <div 
                            tabIndex={0} 
                            role="button" 
                            className="btn btn-ghost text-black hover:bg-transparent active:bg-transparent focus:bg-transparent"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" />
                            </svg>
                ...
                {/* Desktop Navigation - Bluish hover background */}
                <div className="hidden lg:flex flex-grow">
                    <ul className="menu menu-horizontal gap-1 px-1 items-center w-full justify-center">
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>Home</NavLink>
                        </li>
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/aboutus" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>About</NavLink>
                        </li>
                        
                        {/* Community Dropdown */}
                        <li tabIndex={0} className="dropdown dropdown-hover rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <div className={`hover:text-blue-600 cursor-pointer flex items-center gap-1 ${textSizes.base} px-2 py-1 text-black`}>
                                Community
                                <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                        ...
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/allconferences" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>CUMUN</NavLink>
                        </li>
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/resources" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>Resources</NavLink>
                        </li>
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/blogs" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>Blogs</NavLink>
                        </li>
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/announcements" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>Announcements</NavLink>
                        </li>
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/extraevents" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>Events</NavLink>
                        </li>
                        <li className="rounded-md hover:bg-blue-50 transition-colors duration-200">
                            <NavLink to="/contactus" className={`hover:text-blue-600 ${textSizes.base} px-2 py-1`}>Contact</NavLink>
                        </li>
                    </ul>
                </div>
