  ...
  return (
    <div className="relative w-full h-[50vh] md:h-screen overflow-hidden">
      <div className="relative w-full h-full">
        ...
        <div className="absolute inset-0 flex items-center z-10 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
          <div className="text-left max-w-3xl w-full">
            ...
            <div className="text-white">
              ...
              <p className="text-sm sm:text-base md:text-lg leading-relaxed max-w-md sm:max-w-lg mb-4 sm:mb-6">
                CUMUNA, founded on April 30, 2014, is one of Bangladesh's preeminent MUN clubs..
              </p>
