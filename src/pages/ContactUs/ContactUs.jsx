        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <PhoneCall className="w-6 h-6 mt-1 text-black" />
              <div>
                <h4 className="text-xl font-semibold text-black">Phone</h4>
                <p className="text-gray-700">+88016XXXXXX</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">info.cumuna@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">University of Chittagong</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="mt-1 block w-full p-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black"
                  required
                />
              </div>
              <div>
            ...
            <span className="text-black mt-2 block">{result}</span>
          </div>
        </div>
      </motion.div>
    </section>
