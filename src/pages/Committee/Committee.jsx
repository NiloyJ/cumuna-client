      ...
      >
        ...
        <div className="p-6">
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">
                {member.designation === 'Advisor' ? 'Message' : 
                 member.designation === 'Governing_Board' ? 'Tenure Highlights' : 'Bio'}
              </h4>
          ...
          {member.awards?.length > 0 && (
            <div className="mt-6 pt-4 border-t border-gray-200">
              <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">
                {member.designation === 'Governing_Board' ? 'Key Contributions' : 'Awards & Honors'}
              </h4>
              ...
              <div>
                <label htmlFor="message" className="block mb-1 font-medium text-gray-700">
                  {formData.designation === 'Advisor' ? 'Advisor Message' : 
                   formData.designation === 'Governing_Board' ? 'Tenure Highlights' : 'Bio'}
                </label>
                <textarea
                  id="message"
                  ...
                  placeholder={`Enter ${formData.designation === 'Advisor' ? 'a message for this advisor' : 
                              formData.designation === 'Governing_Board' ? 'tenure highlights' : 'a bio'}`}
                />
              </div>
