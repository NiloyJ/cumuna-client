        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="container mx-auto px-4 py-12 bg-white">
                <div className="max-w-3xl mx-auto">
                    ...
                    {/* Date and time at the top of content */}
                    <div className="text-right text-gray-700 text-sm mb-4">
                        Last updated: {getCurrentDateTime()}
                    </div>
                    ...
                    {tags.length > 0 && (
                        <div className="mt-12">
                            <h3 className="text-lg font-semibold mb-4 text-black">Tags</h3>
                            <div className="flex flex-wrap gap-2">
                                {tags.map((tag, index) => (
                                    <span 
                                        key={index} 
                                        className="px-3 py-1 bg-white text-black rounded-full text-sm border border-gray-300"
                                    >
                                        #{tag}
                                    </span>
                                ))}
